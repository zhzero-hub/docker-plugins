...
class Jackett(_PluginBase):
    ...
    # 插件图标
    plugin_icon = "https://raw.githubusercontent.com/zhzero-hub/MoviePilot-Plugins/main/icons/jackett.png"
    # 主题色
    plugin_color = "#000000"
    # 插件版本
    plugin_version = "0.0.18"
    # 插件作者
    plugin_author = "zhzero-hub"
    # 作者主页
    author_url = "https://github.com/zhzero-hub"
    # 插件配置项ID前缀
